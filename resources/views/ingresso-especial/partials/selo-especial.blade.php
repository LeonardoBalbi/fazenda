@php
    ...
    $link = url('/selo_especial/' . base64_encode((string) $selo->id));
...
<div class="form-container">
    <div class="label-container">
        <span style="background-color: #808080;">
            <p class="turismo">SELO ESPECIAL</p>
        ...
        <table>
            ...
            <tr>
                <td colspan="2">
                    ...
                    <input class="ORGANIZADOR" type="text" id="organizador-{{ $selo->id }}" value="{{ strtoupper((string) ($selo->organizador_esp ?? '')) }}" readonly>
                </td>
                <td colspan="2">
    ...
    <span class="assinatura">
        ...
        <input class="n_autorizacao" type="text" id="numero-guia-{{ $selo->id }}" value="{{ SeloIngressoEspecial::mascararAutorizacaoId($selo->id) }}" readonly>

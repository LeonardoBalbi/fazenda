...
<head>
    ...
    <title>Selos especiais — impressão</title>
    <style>
        @media print {
        ...
        .turismo { font-size: 72px; margin-top: 1px; }
        .turismo_t2 {
            font-size: 13px;
            z-index: 1;
            position: relative;
...
<body>
@foreach ($registos as $selo)
    <div class="selo-page">
        @include('ingresso-especial.partials.selo-especial', ['selo' => $selo, 'dataEmissao' => $dataEmissao])
    </div>
@endforeach
</body>
</html>
